...
var ErrRuntimeUnavailable = errors.New("supported Python runtime is unavailable")
...
func ParseVersion(value string) (Version, error) {
	...
	if len(parts) != 3 {
		return Version{}, errors.New("Python version probe returned an unknown version")
	}
	parsed := make([]int, 3)
