...
var externalActions = enumSet(strings.Fields(externalActionValues)...)

const externalActionValues = `AD_CONVERT_ADD_TO_CART
...
AD_CONVERT_TYPE_EFFECTIVE_ACTIVE
...
AD_CONVERT_TYPE_INTENTION_FORM
...
var deepExternalActions = enumSet(strings.Fields(deepExternalActionValues)...)

const deepExternalActionValues = `AD_CONVERT_PAGE_VIEW
...
AD_CONVERT_TYPE_LOCATION_ACTION
AD_CONVERT_TYPE_LOTTERY
AD_CONVERT_TYPE_LTV_ROI_SEVEN
AD_CONVERT_TYPE_LTV_ROI_THIRTY
AD_CONVERT_TYPE_LT_ROI
AD_CONVERT_TYPE_MAP_SEARCH
AD_CONVERT_TYPE_MESSAGE
AD_CONVERT_TYPE_MESSAGE_ACTION
...
AD_CONVERT_TYPE_PURCHASE_ROI_2D
AD_CONVERT_TYPE_PURCHASE_ROI_7D
AD_CONVERT_TYPE_PURCHASE_ROI_THIRTY
AD_CONVERT_TYPE_QC_FOLLOW_ACTION
AD_CONVERT_TYPE_QC_MUST_BUY
AD_CONVERT_TYPE_QQ
AD_CONVERT_TYPE_REDIRECT
