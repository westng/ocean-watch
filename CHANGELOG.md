...
- 巨量营销和巨量千川商品模板支持用户自定义模板名称；营销模板新增项目/广告名称形式，千川商品模板新增受控占位符及默认 `月.日-达人名称-产品名称-类型-商务` 计划名称。千川作品输入支持链接、Markdown 链接或完整口令，并按每行是否提供可选类型与商务来拼接名称；达人名称取本机第三方解析结果，产品名称取投放模板，已有计划追加素材不改名，并兼容迁移旧模板与原有计划命名行为。
