...
This module is the only Ocean Watch business runtime. It implements the stable CLI, state, error, and Presentation contracts around the official Ocean Engine Go SDK and REST endpoints.
