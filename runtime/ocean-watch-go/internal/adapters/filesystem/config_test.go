...
func TestJSONRevisionMatchesStableCanonicalEncoding(t *testing.T) {
	...
	const expectedRevision = "e5f47b4b0cc46bfaec86c17001c2cf764f7bd749c0b2001dab00ded8f9df6d16"
	if revision != expectedRevision {
		t.Fatalf("revision %s does not match stable value %s", revision, expectedRevision)
	}
}
