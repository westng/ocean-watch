...
**Ocean Watch：** 会先校验模板与广告主、商品和渠道的绑定，再保存模板。默认计划名称为 `日期-达人名称-产品名称-类型-商务`；类型和商务不会固化在模板里，而是在每次可能新建计划时填写。

**继续问：** 用刚才的模板处理这些抖音作品。达人没有对应计划就新建，已有计划只追加缺少的素材，先预检。

**Ocean Watch：** 会通过官方接口确认达人授权、作品归属和商品匹配；若需要新建计划，会先收集本次类型和商务，例如生成 `8.4-达人名称-产品名称-随手po-刘研`。已有计划只追加缺少素材，不要求再次填写，也不改计划名称。确认执行后，成功明细固定返回 `计划ID｜达人昵称｜商品ID｜素材ID｜素材标题`，跳过和失败原因单独说明。
