...
**Ocean Watch：** 会通过官方接口确认达人授权、作品归属和商品匹配；若需要新建计划，会先收集本次类型和商务，例如使用模板中的商品简称生成 `8.4-达人名称-防晒霜-随手po-刘研`。已有计划只追加缺少素材，不要求再次填写，也不改计划名称。确认执行后，成功明细固定返回 `计划ID｜达人昵称｜商品ID｜素材ID｜素材标题`，跳过和失败原因单独说明。
