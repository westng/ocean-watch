...
def material_strategy_error(strategy):
    ...
    try:
        ...
        return "template material_strategy.max_materials_per_unit must be an integer"
    if maximum < 1 or maximum > 10:
        return "template material_strategy.max_materials_per_unit must be between 1 and 10"
    ...
    elif strategy.get("creator_filters"):
